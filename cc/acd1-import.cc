...
{
    if (number_of_sera()) {
        rjson_import::update(mData, "titers_list_of_list", "titers_list_of_dict", table_distances, column_bases, disconnected, dodgy_titer_is_regular, avidity_adjusts, multiply_antigen_titer_until_column_adjust);
    }
    else {
