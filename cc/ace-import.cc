...
{
    if (number_of_sera()) {
        rjson_import::update(mData, "l", "d", table_distances, column_bases, disconnected, dodgy_titer_is_regular, avidity_adjusts, multiply_antigen_titer_until_column_adjust, number_of_antigens() + number_of_sera());
    }
    else {
