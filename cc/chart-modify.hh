...
//     {
//       public:
//         inline InfoModify(const rjson::value& aData) : mData{aData} {}
...
//     {
//       public:
//         inline AntigenModify(const rjson::object& aData) : mData{aData} {}
...
//     {
//       public:
//         inline SerumModify(const rjson::object& aData) : mData{aData} {}
...
//     {
//      public:
//         inline AntigensModify(const rjson::array& aData, ace::name_index_t& aAntigenNameIndex) : mData{aData}, mAntigenNameIndex{aAntigenNameIndex} {}
...
//     {
//       public:
//         inline SeraModify(const rjson::array& aData) : mData{aData} {}
...
//     {
//       public:
//         inline TitersModify(const rjson::object& aData) : mData{aData} {}
...
//     {
//       public:
//         inline ColumnBasesModify(const rjson::array& aData) : mData{aData} {}
...
//     {
//       public:
//         inline ProjectionModify(const rjson::object& aData) : mData{aData} {}
...
//     {
//       public:
//         inline ProjectionsModify(const rjson::array& aData) : mData{aData} {}
...
//     {
//       public:
//         inline PlotSpecModify(const rjson::object& aData) : mData{aData} {}
