...
// ----------------------------------------------------------------------
    ...
    class ChartModify : public Chart
    {
     public:
        ...
        void relax_incremetal(size_t source_projection_no, size_t number_of_optimizations, acmacs::chart::optimization_options options, bool report_stresses, const PointIndexList& disconnect_points = {});
