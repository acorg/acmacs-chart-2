...
void print_plot_spec(std::string_view chart_filename)
{
    ...
    for (auto [ag_no, antigen]: acmacs::enumerate(*antigens)) {
        ...
        antigen_fields["outline_color"].push_back(fmt::format("{}", style.outline()));
        ...
        antigen_fields["shape"].push_back(fmt::format("{}", style.shape()));
        antigen_fields["label_shown"].push_back(bool_to_string(style.label().shown));
        antigen_fields["label_color"].push_back(fmt::format("{}", style.label().color));
        antigen_fields["label_font_face"].push_back(style.label().style.font_family);
        antigen_fields["label_font_slant"].push_back(fmt::format("{}", style.label().style.slant));
        antigen_fields["label_font_weight"].push_back(fmt::format("{}", style.label().style.weight));
        ...
        antigen_fields["label"].push_back(std::string{style.label_text()});
    ...
    for (auto [sr_no, serum]: acmacs::enumerate(*sera)) {
        ...
        serum_fields["fill_color"].push_back(fmt::format("{}", style.fill()));
        serum_fields["outline_color"].push_back(fmt::format("{}", style.outline()));
        ...
        serum_fields["shape"].push_back(fmt::format("{}", style.shape()));
        serum_fields["label_shown"].push_back(bool_to_string(style.label().shown));
        serum_fields["label_color"].push_back(fmt::format("{}", style.label().color));
        serum_fields["label_font_face"].push_back(style.label().style.font_family);
        serum_fields["label_font_slant"].push_back(fmt::format("{}", style.label().style.slant));
        serum_fields["label_font_weight"].push_back(fmt::format("{}", style.label().style.weight));
        ...
        serum_fields["label"].push_back(std::string{style.label_text()});
