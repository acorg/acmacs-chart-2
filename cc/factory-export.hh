...
namespace acmacs::chart
{
    ...
    inline void export_factory(const Chart& aChart, std::string_view aFilename, std::string aProgramName, report_time aReport) { return export_factory(aChart, std::string(aFilename), aProgramName, aReport); }
